# -*- coding: utf-8 -*-
"""金錢小達人 競賽申請簡報 V6 — 教科書圖解・教育知識科普風格
基於 V5 架構，對應 V13 申請文件，新增 B 系列亮點、作業單系統詳解、
共 24 張投影片（對應 24 個教學單元）。
"""
import sys
...
for i,(v,l,c) in enumerate([
    ...
    ('15萬+','程式碼行數',AC),('NT$ 0','授權費用',BC),('完全離線','免安裝',TE)]):
...
T(sl,'中華民國 115 年 3 月　　V13',Inches(4.35),Inches(5.55),Inches(4),Inches(.3),
  sz=10,col=GR)
pn(sl,1)
...
for i,(code,name,ic,desc) in enumerate(units_b):
    ...
    MT(sl,desc.split('\n'),bx+Inches(.18),by+Inches(.62),
       Inches(3.76),Inches(1.8),sz=11,col=INK,sp=16)
callout(sl,'📌 B 系列為 A 系列後的延伸應用，強調預算規劃思維與消費比較決策，對應課綱財務管理核心素養',
        Inches(.35),Inches(7.08),Inches(12.6),Inches(.38))
pn(sl,9)
...
sl=prs.slides.add_slide(BLK)
R(sl,Inches(0),Inches(0),SW,SH,fill=BG)
hbar(sl,'B 系列亮點功能——六大互動設計特色',
     '針對預算規劃思維，結合日常生活情境，開發原創互動介面',accent=BC)
...
T(sl,'其他三單元設計亮點',Inches(9.06),Inches(1.28),Inches(3.76),Inches(.38),
  sz=12,bold=True,col=NAV)
HL(sl,Inches(1.72),Inches(9.06),Inches(12.82),col=LN,pt=.8)
b_items=[
    (GO,BCL,'B1 今天帶多少錢','場景篩選5類・行程費用明細\n最少面額提示・進度條・找零公式'),
    (FC,FCL,'B2 零用錢日記','主題篩選3類・收支趨勢指示\n逐項動畫・理財建議・計算過程'),
    (CC,CCL,'B6 菜市場買菜','三市場類型・攤位徽章計數\n結帳確認卡・採購收據・精準付款'),
]
...
T(sl,'中華民國 115 年 3 月　V13',Inches(.2),Inches(7.12),Inches(4.1),Inches(.28),
