...
> **更新日期**：2026-03-27（購買任務彈窗商品圖片放大 128px）、2026-03-14（簡單/輔助點擊模式步驟1–4「點這裡」提示動畫 + 方框；計算機圖片修正）
...
| JS 核心邏輯 | `js/a4_simulated_shopping.js` | 14,682 行 | 673 KB |
| CSS 樣式 | `css/a4_simulated_shopping.css` | 3,528 行 | 81 KB |
