...
| 項目 | 搜尋關鍵字 |
|------|------------|
| B5 錯誤語音統一 + 提示按鈕吉祥物（2026-04-03）| `不對喔，超出預算了`、`不對喔，記得要選` |
| B5 3次錯誤自動提示（2026-04-04）| `roundErrors`、`g.roundErrors >= 3` |
| B5 提示語音含商品價格（2026-04-04）| `nameWithPrice` |
| B5 自訂商品功能（2026-04-04）| `customItemsEnabled`、`b5-custom-items-panel`、`b5-cip-add-btn` |
| B5 困難模式提示彈窗（2026-04-05）| `_showHardModeHintModal`、`b5-hint-modal-overlay`、`b5-hm-close-btn` |
| B5 商品選取浮動標籤（2026-04-05）| `_showItemFlyout`、`b5-item-flyout`、`b5FlyoutUp` |
| B5 afterClose 模式 + 必買逐項語音（2026-04-05）| `_speakMustItemsOneByOne`、`afterClose`、`必買：` |
| B5 設定頁選項排序修正（2026-04-09）| `theme-group`（出現在 `game-settings` 底部）|
| B5 第二頁付款＋找零同步 B6（2026-04-17）| `_b5P2AddCoin`；`b5c-denom-card`、`b5c-wallet-zone`、`b5c-confirm-btn`、`_b5P2SetupChangeInteraction`、`_b5P2ConfirmChange`、`changeGhostMode`、`changeGreedySolution` |
| B5 第一頁提示系統同步 B6（2026-04-18）| `b5-task-card`、`b5-p1-hint-btn`、`b5-hint-here`、`_b5P1ShowHint`、`_b5P1ActivateHintMode`、`p1HintMode` |
| B5 轉場歡迎畫面（2026-04-18）| `showWelcomeScreen`、`b5-wc2-start-btn`、`_skipIntroModal` |
| B5 找零階段同步 B6（2026-04-19）| `_b5P2UpdateChangeTrayHints`、`b5c-wallet-info`、`b6c-hidden`、`找為` |
