...
| 項目 | 搜尋關鍵字 |
|------|------------|
| B1 提示按鈕擴展至普通模式 + 吉祥物（2026-04-03）| `b1-hint-wrap`、`不對喔，你付的錢太少` |
| B1 提示語音格式 + Ghost Slot（2026-04-03）| `b1-wallet-ghost-slot`、`showHint`、`hintSlots`、`可以用` |
| B1 Ghost slot 正確性修正（2026-04-04）| `Ghost slot 模式`、`_updateWalletStatusOnly` |
| B1 任務彈窗語音後關閉＋提示鈕移至行程卡（2026-04-04）| `afterClose`、`b1-schedule-hint-wrap`、`b1-wallet-coins.*background.*#ffffff` |
| B1 測驗2步驟流程＋困難模式總計輸入（2026-04-04）| `_renderPhase1`、`_renderHardTotalInput`、`b1-ht-confirm`、`b1-phase2-ref`、`b1-phase-next-btn` |
| B1 自訂項目功能（2026-04-04）| `customItemsEnabled`、`_getEffectiveTotal`、`b1-custom-items-panel`、`b1-cip-add-btn` |
| B1 今日行程總覽加標題列（2026-04-09）| `b1-review-reward-btn` |
| B1 自訂項目列兩段式樣式 + ? 框鍵盤（2026-04-09）| `_showB1CustomItemNumpad`、`b1-cip-cost-btn`、`customItemsPendingCount` |
| B1/B2 Phase1 提示鈕改金額數字泡泡（2026-04-10）| `b1-cost-hint-tip`、`_showPhase1AmountHints(curr)` |
| B1/B2 金錢圖示全面隨機正反面（2026-04-09）| `trayFaces`、`rf()` |
| B1/B2 Ghost Slot 面向對應拖曳盤（2026-04-09）| `slot.face`、`_autoSetGhostSlots` |
| B1/B2/B5/B6 設定頁新增「自訂選項」題數/關卡（2026-04-09）| `_showSettingsCountNumpad`、`b-snp-overlay` |
